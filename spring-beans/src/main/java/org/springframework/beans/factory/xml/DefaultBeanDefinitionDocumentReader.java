...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	...
	protected void processBeanDefinition(Element ele, BeanDefinitionParserDelegate delegate) {
		//1.	先委托BeanDefinitionDelegate类的parseBeanDefinitionElement方法进行元素解析，返回BeanDefinitionHolder类型的实例bdHolder，经此方法后，bdHolder实例已经包含我们配置文件中的各种属性，如class、name、id、alias之类的属性
		...
		if (bdHolder != null) {
			...
			//4.	最后发出响应时间，通知相关的监听器，这个bean已经加载完成
