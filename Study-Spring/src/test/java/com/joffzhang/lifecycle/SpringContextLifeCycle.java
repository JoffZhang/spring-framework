...
import com.joffzhang.lifecycle.context.ContextLifeCycle;
 ...
 * @date 2021/2/1 11:36
 */
public class SpringContextLifeCycle {
	/**
	 ...
	 */
	@Test
	public void defalutLifecycleProcessor(){
		PrintLog.printMark("初始化Spring容器-START","new AnnotationConfigApplicationContext(ContextLifeCycle.class)");
		AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(ContextLifeCycle.class);
		PrintLog.printMark("初始化Spring容器-END","new AnnotationConfigApplicationContext(ContextLifeCycle.class)");
